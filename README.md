...
- `Apply for 3 days annual leave starting from 20/6/2026 till 22/6/2026`
- `Apply for 3 days annual leave`, then follow up with `start date is 27/6/2026`
...
- Date handling: leave requests accept natural month forms (`Jun 15`, `20th June`, `jun15`) and numeric Indian-style dates (`20/6/2026`).
